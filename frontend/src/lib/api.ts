...
export const aiApi = {
  ...
  coverImage: (title: string, brief: string, style: string, adjustments?: string, currentSvg?: string) =>
    api.post("/admin/ai/cover-image", { title, brief, style, adjustments, current_svg: currentSvg }),
};

        ...
        <motion.div {...fadeUp}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              ...
              { icon: Phone, glyph: "cyan", label: "Matt Barker", value: "(603) 556-8277", href: "tel:+16035568277" },
          ...
          {status === "done" ? (
            ...
            <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                ...
                <input required style={inputStyle} value={form.full_name} onChange={set("full_name")} />
              </div>
              <div>
              ...
              <div>
                <label style={{ fontSize: 13, color: "var(--text-muted)", display: "block", marginBottom: 6 }}>Work Email *</label>
                <input required type="email" style={inputStyle} value={form.email} onChange={set("email")} />
              </div>
              <div>
                <label style={{ fontSize: 13, color: "var(--text-muted)", display: "block", marginBottom: 6 }}>Phone</label>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                ...
                <div>
                  <label style={{ fontSize: 13, color: "var(--text-muted)", display: "block", marginBottom: 6 }}>Team Size</label>
                  <select style={inputStyle} value={form.team_size} onChange={set("team_size")}>
                    <option value="">Select…</option>
              ...
              <div>
                <label style={{ fontSize: 13, color: "var(--text-muted)", display: "block", marginBottom: 6 }}>Anything you'd like us to know?</label>
                <textarea rows={3} style={{ ...inputStyle, resize: "vertical" }} value={form.message} onChange={set("message")} />
              </div>
              {status === "error" && <p style={{ color: "var(--danger)", fontSize: 14 }}>{error}</p>}
